# Evaluates prompt tuned and RAG responses, no post generation filtering done yet
import os
import pandas as pd
import json
...
evaluate_model(
    model_name="Final Combined GPT3.5 (Post-Filtered)",
    input_path="outputs/filtered_combined_responses_evaluated.csv",
    output_path="evaluations/final_combined_evaluated.csv",
